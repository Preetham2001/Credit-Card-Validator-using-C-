...
int main() {
    ...
    while (true) {
        ...
        cout << "Please enter a CC number to validate it using the algorithm: ";
        cin >> ccNumber;
        ...
        // Step 1 is to double every second digit, starting from the right. If it results in a two digit number, add both the digits to obtain a single
        ...
        cout << (doubleEvenSum % 10 == 0 ? "It is a Valid credit card number!" : "Invalid!,please check the credit card number you have entered") << endl;
